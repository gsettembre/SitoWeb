...
<html>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<h1><strong><a href="areariservata.php">Museo Archeologico di Durazzo</a></strong></h1>
				<nav id="nav">
					<ul>
		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="container">					
					<section>
						<header>
							<p><?php $username = $_SESSION['username']; echo 'Ciao, '; echo htmlspecialchars($username); ?></p><h3>Benvenuto nell'area riservata dedicata agli amministratori.</h3>
